                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/fufeiwendaxitong/upload/forumMuBan.xls"
                        >批量导入问题帖子信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('forum','查看') && role == '管理员'" type="primary" icon="el-icon-edit" size="mini" @click="openReplyForum(scope.row.id,scope.row.forumName,scope.row.forumContent)">查看问题帖子回复</el-button>
...
<script>
	...
	fufeixinxi:0,
            ...
            forumReplyDialogVisible : false,//问题帖子回复模态框
            forumReplyInfoDialogVisible : false,//问题帖子回复详情模态框
            superIds : "",//帖子id
            forumTitle : "",//帖子标题
            forumContent : "",//帖子内容
            forumReplyContent : "",//帖子回复内容
            forumReplyInfoContent : "",//帖子某个回复详情 全
            forumData : [],//问题帖子回复数据集合
        ...
        methods: {
            ...
            // 当前帖子相关 end
                ...
                _this.forumReplyDialogVisible = true;//问题帖子回复模态框
                _this.forumReplyInfoDialogVisible = false;//问题帖子回复详情模态框
            ...
            seeForumContent(forumContent) {
                ...
                _this.forumReplyInfoDialogVisible = true;//问题帖子回复详情模态框
            },
            // 删除数据
            deleteForumData(id){
                let _this = this;

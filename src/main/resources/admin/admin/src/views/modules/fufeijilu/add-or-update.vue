        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='forum'">
                    <el-form-item class="select" v-if="type!='info'"  label="问题帖子信息" prop="forumId">
                        <el-select v-model="ruleForm.forumId" :disabled="ro.forumId" filterable placeholder="请选择问题帖子信息" @change="forumChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='forum' ">
                    <el-form-item class="input" v-if="type!='info'"  label="父id" prop="superIds">
                        <el-input v-model="forumForm.superIds"
                                  placeholder="父id" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='forum' ">
                    <el-form-item class="input" v-if="type!='info'"  label="帖子状态" prop="forumStateValue">
                        <el-input v-model="forumForm.forumStateValue"
                                  placeholder="帖子状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '付费时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fufeijilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fufeijiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
